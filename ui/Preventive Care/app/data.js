  ...
  const services = [
    {
      ...
      whyHere: "Best place to request your missing cholesterol test and book an NHS Health Check.",
      rating: "CQC: Good",
      nextAvail: "Health Check appts ~1 week",
      offers: ["NHS Health Check", "Cholesterol/lipid blood test", "Blood pressure", "Diabetes (HbA1c) test", "GP consultation"],
      eligibility: "Registered patients. Not registered? Free to join — bring ID and proof of address.",
      access: ["Step-free access", "Accessible toilet", "Hearing loop"],
      hours: "Mon–Fri 8:00–18:30 · Sat 9:00–12:00",
      bring: "List of medicines + your questions from the report."
    },
    {
      id: "svc-ardwick",
      ...
      whyHere: "Alternative GP practice nearby also offering NHS Health Checks.",
      rating: "CQC: Good",
      nextAvail: "Routine appts ~3 days",
      offers: ["NHS Health Check", "Blood pressure", "Cholesterol/lipid blood test", "GP consultation"],
      eligibility: "Registered patients within the practice catchment.",
      access: ["Step-free access", "Accessible parking"],
      hours: "Mon–Fri 8:00–18:00",
      bring: "Photo ID if you're a new patient."
    },
    {
      ...
      whyHere: "Walk in for a FREE NHS blood-pressure check — your single highest-value next step. No appointment, no GP referral.",
      ...
      eligibility: "Free BP check for anyone 40+ in England. No booking needed.",
    ...
    },
    {
      ...
      badge: "Free BP check",
      open: "Open · closes 6:00pm",
      whyHere: "Closer free BP-check option on your commute along Oxford Road.",
    ...
    },
    {
      ...
      whyHere: "Your nearest acute hospital. You'd only come here for prevention if your GP refers you — not a walk-in for checks.",
      ...
      eligibility: "Referral from your GP for planned cardiology/diabetes care. A&E for emergencies only.",
    ...
    },
    {
      ...
      open: "A&E open 24 hours",
      whyHere: "Regional cardiology centre — relevant only if you're later referred for specialist heart assessment.",
      rating: "Specialist cardiothoracic centre",
      nextAvail: "By GP referral only",
      offers: ["Cardiology & cardiothoracic (referral)", "Heart investigations", "A&E 24h"],
      eligibility: "Referral required for planned cardiology care.",
      access: ["Step-free access", "Accessible parking"],
      hours: "A&E 24 hours · outpatients Mon–Fri",
      bring: "Referral letter and appointment reference."
    },
